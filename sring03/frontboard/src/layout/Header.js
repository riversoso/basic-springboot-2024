      ...
      <header className='d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom'>
        ...
        <div className='col-md-3 text-end me-3'>
          {localStorage.getItem("username") != "" ? (
            ...
            <>
          <button type='button' className='btn btn-sm btn-outline-primary me-2' onClick={gotoLogin}>로그인</button>
          <button type='button' className='btn btn-sm btn-outline-primary'>회원가입</button>
          </>
          )}
        </div>
      </header>
